...
-(void)getHomeImageInDB
{
   ...
   // NSData *imageData = [NSData dataWithContentsOfURL:[NSURL URLWithString:@"http://108.178.27.242/luigi/img/product/front/image_front2.png"]];
   // [[TabSquareDBFile sharedDatabase]insertIntoHomeImageTableWithRecord:@"2" imageName:@"image2" imageData:imageData];
    
   /* NSData *image=[[TabSquareDBFile sharedDatabase]getHomeImageData:@"2"];
    backhomeView.image=[UIImage imageWithData:image];*/
